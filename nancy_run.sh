...
function collect_results() {
  ...
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_archiver) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_archiver.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_bgwriter) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_bgwriter.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_database) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_database.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_database_conflicts) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_database_conflicts.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_all_tables) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_all_tables.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_xact_all_tables) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_xact_all_tables.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_all_indexes) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_all_indexes.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_statio_all_tables) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_statio_all_tables.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_statio_all_indexes) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_statio_all_indexes.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_statio_all_sequences) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_statio_all_sequences.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_user_functions) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_user_functions.csv with csv;"
  docker_exec bash -c "psql -U postgres $DB_NAME -b -c \"copy (select * From pg_stat_xact_user_functions) To STDOUT With CSV HEADER DELIMITER ',';\" > /$MACHINE_HOME/$ARTIFACTS_FILENAME/pg_stat_xact_user_functions.csv with csv;"
